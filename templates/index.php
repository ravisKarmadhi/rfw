...
<main>
  <?php if (have_rows('page_builder')): $i = 1;
    while (have_rows('page_builder')): the_row(); $i++;
                ...
                <div class="row">
                  <div class="col-lg-6 col-12 mx-auto">
                    <div class="text-center dpt-30 tpt-25">
                      ...
                      <?php endif;?>
                      <div class="d-flex flex-wrap align-items-center justify-content-center tmt-20">
                        <?php if (!empty($hero_section_button_1['url'])): $target_1 = ($hero_section_button_1['target'] == "_blank") ? "_blank" : "";?>
                          <a href="<?php echo $hero_section_button_1['url']; ?>" target="<?php echo $target_1; ?>" class="btnA bgdark-8B6E3D-btn text-decoration-none classic font-15 dmt-20 tmt-10 mx-2">
                            <?php echo $hero_section_button_1['title']; ?>
                          </a>
                        <?php endif;?>
                        <?php if (!empty($hero_section_button_2['url'])): $target_2 = ($hero_section_button_2['target'] == "_blank") ? "_blank" : "";?>
                          <a href="<?php echo $hero_section_button_2['url']; ?>" target="<?php echo $target_2; ?>" class="btnA bg-FFFAF6-btn text-decoration-none classic font-15 dmt-20 tmt-10 mx-2">
        ...
        <section class="accommodation-hero-section position-relative">
          <?php if (!empty($small_hero_section_background_image['url'])): ?>
            <div class="accommodation-hero-img position-relative">
              <img class="h-100 w-100 object-cover" src="<?php echo $small_hero_section_background_image['url']; ?>" alt="">
      ...
      if (!empty($bottom_fix_line_text)): ?>
        <div class="bg-BDA673 lh-1 py-2 position-fixed z-2 bottom-0 left-0 w-100 text-center " id="bottom-home">
          <p class="text-decoration-none text-FFFAF6 classic fw-normal font-14 leading-20 col-9 mx-auto d-block">
            ...
            <?php if (!empty($bottom_fix_line_link['url'])): $target_3 = ($bottom_fix_line_link['target'] == "_blank") ? "_blank" : ""; ?>
              <span class="d-lg-inline-block d-block"> 
                <a href="<?php echo $bottom_fix_line_link['url']; ?>" target="<?php echo $target_3; ?>" class="text-decoration-none text-FFFAF6 classic fw-normal font-14 lh-1"> <?php echo $bottom_fix_line_link['title']; ?> </a>
              </span>
            <?php endif;?>
          </p>
            ...
            <div class="row">
              <div class="col-lg-11 mx-auto position-relative">
                <div class="image-timeless">
                  ...
                  <?php endif; if (!empty($all_side_image_section_top_right_image['url'])): ?>
                  ...
                  <?php endif; if (!empty($all_side_image_section_bottom_left_image['url'])): ?>
                  ...
                  <?php endif; if (!empty($all_side_image_section_bottom_right_image['url'])): ?>
                ...
                <div class="col-xl-7 mx-auto">
                  <div class="text-center dpt-55 tpt-175 dpb-350 tpb-250">
                    <span class="d-block louise font-137 leading-158 text res-font-105"><?php echo $all_side_image_section_top_heading; ?></span>
                    <span class="classic font-87 text-uppercase leading-90 mt-lg-n5 mt-n4 d-block text res-font-48">
                      <?php echo $all_side_image_section_bottom_heading; ?>
                    </span>
                    <div class="dmt-15 tmt-25 classic font-15 text leading-26 col-lg-10 col-12 mx-auto">
                      <?php echo $all_side_image_section_content; ?>
                    </div>
                    <div class="d-flex flex-wrap align-items-center justify-content-center col-10 mx-auto">
                      <?php if (!empty($all_side_image_section_button['url'])): $target_6 = ($all_side_image_section_button['target'] == "_blank") ? "_blank" : "";?>
                        <a href="<?php echo $all_side_image_section_button['url']; ?>" target="<?php echo $target_6; ?>" class="btnA link mx-2 text-decoration-none classic font-15 text-capitalize dmt-15 tmt-25">
              ...
              <div class="col-lg-12 col-10 mx-auto">
                <div class="bg-2D4232 dpt-65 dpb-65 tpt-45 tpb-35">
                  <div class="d-lg-flex align-items-center justify-content-center">
                    ...
                    <?php endif;?>
                    <?php if (!empty($want_to_download_button['url'])):  $target_7 = ($want_to_download_button['target'] == "_blank") ? "_blank" : "";  ?>
        ...
        <section id="two-block-<?php echo $i; ?>">
          <div class="container px-p-0">
            <div class="row mx-lg-n2">
              <?php foreach ($two_block_section_items as $two_block_section_items_custom): if (!empty($two_block_section_items_custom['heading'])): ?>
                  ...
                  <div class="single-brochure w-100 position-relative">
                    <div class="brochure-img overflow-hidden card-hover w-100 h-100">
                      ...
                      <div class="position-absolute top-left-center w-100 text-center px-4">
                        <div class="louise text-FFFAF6 font-77 lh-1 res-font-40 res-classic">
                          <?php echo $two_block_section_items_custom['heading']; ?>
                        </div>
                        <?php if (!empty($two_block_section_items_custom['button']['url'])): $target_8 = ($two_block_section_items_custom['button']['target'] == "_blank") ? "_blank" : ""; ?>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6 col-11 mx-auto text-center px-lg-2">
              ...
              <?php endif;?>
              <?php if (!empty($middle_content_button['url'])): $target_9 = ($middle_content_button['target'] == "_blank") ? "_blank" : ""; ?>
                <a href="<?php echo $middle_content_button['url']; ?>" target="<?php echo $target_9; ?>" class="btnA bg-8B6E3D-btn text-decoration-none classic font-15 mx-auto dmt-25">
    ...
    <?php elseif (get_row_layout() == 'single_panel'):
      ...
      $single_panel_button = get_sub_field('button'); ?>
        <section class="brochure-section position-relative">
          <div class="container px-p-0">
        ...
        <div class="container px-p-0">
          <div class="row">
            <div class="col-12 video-img-play position-relative overflow-hidden">
              ...
              <?php endif;?>
              <?php if (!empty($full_video_video_options == 'video')):  if (!empty($full_video_video['url'])): ?>
                ...
                <div class="top-left-center position-absolute w-100 text-center">
                  <button class="btnA bgdark-BDA673-btn text-FFFAF6 text-decoration-none classic font-15 mx-auto" id="play-banner-video">
                      Play Video
                  </button>
                  <button class="btnA bgdark-BDA673-btn text-FFFAF6 text-decoration-none classic font-15 mx-auto d-none" id="pause-banner-video">
                      pause Video
                  </button>
                </div>
              <?php endif; ?>
              <?php elseif ($full_video_video_options == 'youtube'):
                if (!empty($full_video_youtube['url'])): ?>
                  ...
                  <div class="top-left-center position-absolute w-100 text-center">
                    <button class="btnA bgdark-BDA673-btn text-FFFAF6 text-decoration-none classic font-15 mx-auto" id="play-banner-iframe">
                        Play Video
                    </button>
                  </div>
              <?php endif; elseif ($full_video_video_options == 'vimeo'):
                  ...
                  $sleeps = get_field('sleeps', $id);  ?>
                    <div class="col-lg-6 px-2">
                      <div class="single-sleeps w-100 overflow-hidden">
                        <a href="<?php echo get_permalink($id); ?>" class="w-100 h-100 card-hover position-relative d-inline-block">
                          ...
                          <div class="position-absolute top-0 dpt-125 tpt-00 left-center text-center col-lg-8 col-10 px-3 mx-auto single-sleeps-content">
                            ...
                            <button class="btnA bgdark-8B6E3D-btn text-center text-FFFAF6 font-15 classic mx-auto dmt-30 tmt-20 d-block">
                              Take A Look Around
                            </button>
                          </div>
                        </a>
        ...
        <div class="container px-p-0">
          <div class="row">
            <div class="col-lg-6 pe-lg-5 details-content d-flex flex-column justify-content-center">
              ...
              <?php if (!empty($left_right_image_content_8_4_button['url'])): $target_11 = ($left_right_image_content_8_4_button['target'] == "_blank") ? "_blank" : "";?>
                <div class="btns-row d-lg-flex align-items-center dmt-35 tmt-30 px-p-p">
        ...
        <section class="gallery-section">
          <div class="container px-p-0">
            ...
            <div class="filter-activity d-flex flex-wrap px-p-p tmb-50">
              <?php while ($master->have_posts()): $master->the_post();
                $id = get_the_ID();
                    ...
                    <div class="modal-body">
                      ...
                      <div id="carouselExampleFade" class="carousel slide carousel-fade position-relative" data-bs-ride="carousel">
                        <div class="carousel-inner">
                          <?php $i = 1;while ($master->have_posts()): $master->the_post();
                            $id = get_the_ID();
                            $ntitle = get_the_title();
                            $clss = ($i == 1) ? "active" : "";?>
    ...
    <?php elseif (get_row_layout() == 'products'): ?>
      <?php $product_value = new WP_Query([
        'post_type' => 'product',
        'posts_per_page' => -1,
        'orderby' => 'date',
        'order' => 'ASC',]); ?>
        ...
        <section class="farmhouse-section">
          <div class="container">
            <div class="col-lg-10 col-12 mx-auto">
              <?php while ($product_value->have_posts()): $product_value->the_post();
                $id = get_the_ID();
                $ntitle = get_the_title();
                  ...
                  <div class="dpb-35 tpb-70 dpt-35 tpt-70 farmhouse-item border-bottom-EBEBEB">
                    <a href="<?php echo get_permalink($id); ?>" class="d-flex flex-column flex-lg-row align-items-center flex-wrap text-decoration-none">
                      <div class="col-lg-7 col-12 col-12 order-1 order-lg-0">
                        ...
                        <div class="classic font-16 leading-20 text-2C2924">
                        ...
                        <div class="col-lg-5 col-12 order-0 order-lg-1 ps-lg-2">
                          <div class="farmhouse-img w-100 tmb-35 card-hover overflow-hidden">
                            <img class="h-100 w-100 object-cover img" src="<?php echo get_the_post_thumbnail_url($id); ?>" alt="<?php echo $ntitle; ?>">
                          </div>
                        </div>
                      </div>
                    </a>
    ...
    <?php elseif (get_row_layout() == 'faq'):
      ...
      if ($faq->have_posts()): ?>
	      <section class="faq-section">
            ...
            <div class="faq-category d-flex justify-content-md-center align-items-center pe-lg-0 overflow-x-auto dmb-35 ">
            ...
            <div class="px-p-p">
              <div class="faq-search col-xl-7 col-lg-10 col-12 px-lg-1 mx-auto dmb-50">
                  <div class="col-lg-11 col-12 mx-auto position-relative">
                      <input class="faq-input border-0 dpt-25 dpb-25 radius-3 ps-4 w-100 classic font-15 leading-20 text-FFFAF6"
                      ...
                      $button = get_field('button', $id);?>
                        <div class="faq-closet-item dmb-15">
                          <div class="faq-closet closet-item ps-3 ps-lg-5">
                            <div class="closet-header cursor-pointer d-flex justify-content-between py-3 align-items-center">
                              <div class="classic font-22 res-font-18 leading-30 res-leading-26 text-FFFAF6 dpt-20 dpb-20">
                                <?php echo $ntitle; ?>
                              </div>
                              <div class="pe-lg-4 pe-2">
                                <img class="accordion-header-img"src="<?php echo get_home_url() ?>/wp-content/uploads/2024/05/faq.svg" alt="">
                              </div>
                            </div>
    ...
    <?php elseif (get_row_layout() == 'contact_us'):
      ...
      $contact_us_form_heading = get_sub_field('form_heading'); ?>
	      <section class="contact-section contact-bg position-relative tpt-235 dpt-230">
                    ...
                    <?php if (!empty($contact_us_phone_number)): ?>
                      <div class="d-flex align-items-center justify-content-center dmb-10">
                        <div class="me-2 contact-icon">
                          <img src="<?php echo get_home_url(); ?> /wp-content/uploads/2024/05/contact-call.svg" alt="">
                        </div>
                        <a href="tel:<?php echo $contact_us_phone_number; ?>" class="font-15 leading-20 classic fw-normal text-center text-FFFAF6 text-decoration-none">
                  ...
                  <div class="col-12 col-md-5 tmb-65">
                    ...
                    <?php if (!empty($contact_us_location)): ?>
                      <div class="d-inline-flex ">
                        ...
                        <a href="<?php echo $contact_us_location_link['url']; ?>" class="font-15 leading-20 classic fw-normal text-center text-FFFAF6 text-decoration-none">
                          <?php echo $contact_us_location; ?>
                        </a>
                      </div>
                    <?php endif;?>
                  </div>
          ...
          <div class="position-absolute start-0 top-0 privacy-re-img dmt-95">
            <img class="h-100" src="<?php echo get_home_url() ?>/wp-content/uploads/2024/05/logo-layer.svg" alt="">
          </div>
        </section>
              ...
              <?php foreach ($three_block_section_items as $three_block_section_items_custom):
                ...
                $target_12 = ($three_block_section_items_custom['button']['target'] == "_blank") ? "_blank" : ""; ?>
                  <div class="col-12 col-lg-4 px-2 three-cards mb-2">
                    <a href="<?php echo $three_block_section_items_custom['button']['url']; ?>" class="three-card h-100 w-100 card-hover position-relative overflow-hidden d-inline-block">
                      <img src="<?php echo $three_block_section_items_custom['image']['url']; ?>" alt="" class="w-100 h-100 object-cover img">
