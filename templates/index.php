	    ...
	    <div class="container">
	        <div class="row">
	            <div class="col-lg-11 mx-auto position-relative">
                  ...
                  <?php if (!empty($hero_section_bottom_heading)): ?>
                    <span class="text-FFFAF6 lh-1 mt-lg-n3 mt-n2 d-block font-64 text-uppercase classic  res-font-40">
                      <?php echo $hero_section_bottom_heading; ?>
                    </span>
                  <?php endif;?>
...
if (!empty($all_side_image_section_bottom_right_image['url'])): ?>
    ...
    ?>
        ...
        <?php elseif (get_row_layout() == 'two_block_section'):
          $two_block_section_items = get_sub_field('items'); if (!empty($two_block_section_items)): ?>
	                    ...
	                    <div class="dpb-35 tpb-70 dpt-35 tpt-70 farmhouse-item border-bottom-EBEBEB">
	                        <a href="<?php echo get_permalink($id); ?>" class="d-flex flex-column flex-lg-row align-items-center flex-wrap text-decoration-none">
	                            <div class="col-lg-7 col-12 col-12 order-1 order-lg-0">
	                                ...
	                                <div class="classic font-16 leading-20 text-2C2924"><?php echo $sleeps; ?>
	                                <?php if (!empty($night)): ?>| <?php echo $night; ?><?php endif;?></div>
                            ...
                            <div class="col-lg-5 col-12 order-0 order-lg-1 ps-lg-2">
                                <div class="farmhouse-img w-100 tmb-35 card-hover overflow-hidden">
                                    <img class="h-100 w-100 object-cover img"
