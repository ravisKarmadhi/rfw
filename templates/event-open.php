    ...
    <section class="event-open-section">
        <div class="container px-p-0">
            <div class="px-p-p">
                ...
                <div class="classic font-38 leading-40 fw-normal text-2C2924 dmb-30">
                    Wine Tasting
                </div>
                <div class="classic font-18 leading-20 fw-normal text-2C2924 dmb-50">
                    April 4 @ 9.30am
                </div>
            </div>
            <div class="event-open-img dmb-65 tmb-50">
                <img src="<?php echo get_home_url() ?>/wp-content/uploads/2024/05/video-3.png" alt="video-3.png" class="h-100 w-100 object-cover">
            </div>
            <div class="px-p-p">
                <div class="col-lg-11 col-12 pe-lg-4 dmb-75 tmb-50">
                    <div class="classic font-16 leading-28 fw-normal text-2C2924 dmb-30 res-font-15 res-leading-26">
            ...
            <div class="col-xl-6 col-lg-7 col-12 pe-xl-2 dmb-30 px-lg-0 px-2">
                <div class="book-ticket-box border-EBEBEB dpt-35 dpb-40 radius-5">
                    ...
                    <button class="btnA bg-BDA673-btn w-110px classic-med font-14 leading-16 text-capitalize radius-5 h-50px res-w-160px ms-lg-auto">Get Tickets</button>
                </div>
            </div>
